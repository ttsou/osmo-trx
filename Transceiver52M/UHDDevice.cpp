...
static const std::map<dev_key, dev_desc> dev_param_map {
	...
	{ std::make_tuple(USRP2, 4, 1), { 1, 0.0,  390625,  7.6547e-5,  "N2XX 4/1 SPS"       } },
	{ std::make_tuple(USRP2, 4, 4), { 1, 0.0,  390625,  4.6080e-5,  "N2XX 4 SPS"         } },
	{ std::make_tuple(B100,  1, 1), { 1, 0.0,  400000,  1.2104e-4,  "B100 1 SPS"         } },
	{ std::make_tuple(B100,  4, 1), { 1, 0.0,  400000,  7.9307e-5,  "B100 4 SPS"         } },
...
bool uhd_device::parse_dev_type()
{
	...
	dev_type = std::get<uhd_dev_type>(devStringMap.at(found));
	tx_window = std::get<TxWindowType>(devStringMap.at(found));
	return true;
}
