...
//	std::cout << "(" << recvBuffer[0]->getSegmentLen()
//		  << ", " << channelizer->outputLen() << ")" << std::endl;
...
//		lte_dsock_send((float *) channelizer->outputBuffer(pchan),
//			       channelizer->outputLen(), lchan);
...
//		lte_dsock_send((float *) wr_segment,
//			       recvBuffer[lchan]->getSegmentLen(), 2 + lchan);
	}
}
...
//	std::cout << "(" << sendBuffer[0]->getSegmentLen()
//		  << ", " << synthesis->inputLen() << ")" << std::endl;
